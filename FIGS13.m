...
odeparams.tar_si=0.7; %IFG weak gamma
odeparams.tau_si=360000; 
odeparams.tar_hepasi=0.6;%IFG weak gamma
odeparams.tau_hepasi=360000;
odeparams.Gs=115;%IFG weak gamma
...
%% plot data
DATA=readtable('IFG_weak_gamma.xlsx');
fs=12;
fn='arial';
