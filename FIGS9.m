...
odeparams.tar_si=0.8; %MODY extreme GOP
odeparams.tau_si=360000; 
odeparams.tar_hepasi=1;%MODY extreme GOP
odeparams.tau_hepasi=360000;
odeparams.Gs=140;%MODY extreme GOP
...
%% plot data
DATA=readtable('MODY_extreme_GOP.xlsx');
fs=12;
fn='arial';
...
text(4,285,'2hPG', 'fontsize',fs2,'fontname',fn);
...
text(1,32,'2hPI', 'fontsize',fs2,'fontname',fn);
text(1,10, 'FPI','fontsize',fs2,'fontname',fn);
