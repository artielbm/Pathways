...
odeparams.tar_si=0.1; %FIG1,2
odeparams.tau_si=360000; 
odeparams.tar_hepasi=0.85;%FIG1,2
odeparams.tau_hepasi=360000;
odeparams.Gs=90; %FIG2
odeparams.ISRI_bar=0.5259; % beta-function defect for all FIGs, default:1.4
...
%load permanent_IGT.dat; 
permanent_IGT=readtable('FIG2.xlsx');



permanent_IGT_t=permanent_IGT{:,1};
permanent_IGT_FG=permanent_IGT{:,2};
permanent_IGT_2hG=permanent_IGT{:,4};
permanent_IGT_FI=permanent_IGT{:,5};
permanent_IGT_2hI=permanent_IGT{:,7};

permanent_IGT_si=permanent_IGT{:,12};
permanent_IGT_HGP=permanent_IGT{:,13};
permanent_IGT_sigma=permanent_IGT{:,11};
permanent_IGT_b=permanent_IGT{:,9};
...
plot(permanent_IGT_t./(365*1440),permanent_IGT_si.*6.9444,'k', 'linewidth',lw);
%hold('on')
...
plot(permanent_IGT_t./(365*1440),permanent_IGT_HGP,'k', 'linewidth',lw);
%hold('on')
...
plot(permanent_IGT_t./(365*1440),permanent_IGT_FG,'k', 'linewidth',lw);

hold('on')
plot(permanent_IGT_t./(365*1440),permanent_IGT_2hG,'k', 'linewidth',lw);
...
text(4,200,'2hPG', 'fontsize',fs2,'fontname',fn);
text(4,120, 'FPG','fontsize',fs2,'fontname',fn);
...
text(0.13,40,'NGT','fontsize',fs10,'fontname',fn);
text(3.4,40,'IGT','fontsize',fs10,'fontname',fn);
...
tI=subplot(3,2,4);
plot(permanent_IGT_t./(365*1440),permanent_IGT_FI,'k', 'linewidth',lw);

hold('on')
plot(permanent_IGT_t./(365*1440),permanent_IGT_2hI,'k', 'linewidth',lw);
...
text(4,128,'2hPI', 'fontsize',fs2,'fontname',fn);
text(4,38, 'FPI','fontsize',fs2,'fontname',fn);
