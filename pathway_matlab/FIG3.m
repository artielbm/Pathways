...
odeparams.tar_si=0.5; %FIG3
odeparams.tau_si=360000; 
odeparams.tar_hepasi=0.1;%FIG3
...
%load NGT_IFG_CGI_T2D.dat; 
NGT_IFG_CGI_T2D=readtable('FIG3.xlsx');



NGT_IFG_CGI_T2D_t=NGT_IFG_CGI_T2D{:,1};
NGT_IFG_CGI_T2D_FG=NGT_IFG_CGI_T2D{:,2};
NGT_IFG_CGI_T2D_2hG=NGT_IFG_CGI_T2D{:,4};
NGT_IFG_CGI_T2D_FI=NGT_IFG_CGI_T2D{:,5};
NGT_IFG_CGI_T2D_2hI=NGT_IFG_CGI_T2D{:,7};

NGT_IFG_CGI_T2D_si=NGT_IFG_CGI_T2D{:,12};
NGT_IFG_CGI_T2D_HGP=NGT_IFG_CGI_T2D{:,13};
NGT_IFG_CGI_T2D_sigma=NGT_IFG_CGI_T2D{:,11};
NGT_IFG_CGI_T2D_b=NGT_IFG_CGI_T2D{:,9};
...
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_si.*6.9444,'k', 'linewidth',lw);
%hold('on')
...
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_HGP,'k', 'linewidth',lw);
%hold('on')
...
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_FG,'k', 'linewidth',lw);

hold('on')
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_2hG,'k', 'linewidth',lw);
...
text(3.8,260,'2hPG', 'fontsize',fs2,'fontname',fn);
text(4,168, 'FPG','fontsize',fs2,'fontname',fn);
...
text(1.8,40,'IFG','fontsize',fs10,'fontname',fn);
...
tI=subplot(3,2,4);
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_FI,'k', 'linewidth',lw);

hold('on')
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_2hI,'k', 'linewidth',lw);
...
text(4,55,'2hPI', 'fontsize',fs2,'fontname',fn);
text(3,31, 'FPI','fontsize',fs2,'fontname',fn);
...
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_sigma,'k', 'linewidth',lw);
%hold('on')
...
plot(NGT_IFG_CGI_T2D_t./(365*1440),NGT_IFG_CGI_T2D_b,'k', 'linewidth',lw);
%hold('on')
