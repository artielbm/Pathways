...
long_IVGTT=[T0(:),G0(:),G1(:),G2(:),G3(:),G4(:),G5(:),G6(:),G7(:),G8(:),G9(:),G10(:),G11(:),G12(:),G13(:),G14(:),G15(:),G20(:),G25(:),G30(:),G60(:),G90(:),G120(:),I0(:),I1(:),I2(:),I3(:),I4(:),I5(:),I6(:),I7(:),I8(:),I9(:),I10(:),I11(:),I12(:),I13(:),I14(:),I15(:),I20(:),I25(:),I30(:),I60(:),I90(:),I120(:)];
tmp_long_IVGTT=array2table(long_IVGTT,'VariableNAME',{'t','G0','G1','G2','G3','G4','G5','G6','G7','G8','G9','G10','G11','G12','G13','G14','G15','G20','G25','G30','G60','G90','G120','I0','I1','I2','I3','I4','I5','I6','I7','I8','I9','I10','I11','I12','I13','I14','I15','I20','I25','I30','I60','I90','I120'});
writetable(tmp_long_IVGTT,outfile) 



%% plot data
DATA=readtable('FIG7.xlsx');
fs=12;
fn='arial';


figure(1)
plot(IVGTT_t,DATA{1,24:45})
hold('on')
plot(IVGTT_t,DATA{4,24:45})
plot(IVGTT_t,DATA{6,24:45})
plot(IVGTT_t,DATA{8,24:45})
%ylim([0 150])
hold('off')
ylabel('{Insulin} ({\mu}U/ml)','fontsize', fs, 'fontname',fn);

%figure(2)
%plot(IVGTT_t,DATA{4,2:23})
%hold('on')
%plot(IVGTT_t,DATA{6,2:23})
%plot(IVGTT_t,DATA{8,2:23})
