...
%% plot data
DATA=readtable('FIG6.xlsx');
fs=12;
fn='arial';

figure(1)
plot(OGTT_t,DATA{1,2:14})
hold('on')
plot(OGTT_t,DATA{4,2:14})
plot(OGTT_t,DATA{6,2:14})
plot(OGTT_t,DATA{8,2:14})
...
figure(2)
plot(OGTT_t,DATA{1,15:27})
hold('on')
plot(OGTT_t,DATA{4,15:27})
plot(OGTT_t,DATA{6,15:27})
plot(OGTT_t,DATA{8,15:27})
%ylim([0 150])
hold('off')
