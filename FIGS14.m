...
outfile='IFG_weak_r20.xlsx';
odeparams.k=0.4861;

odeparams.meal=1;
odeparams.OGTT=0;
odeparams.IVGTT=0;
odeparams.r20=0.0003; %IFG weak r20

odeparams.tar_si=0.7; %IFG weak r20
odeparams.tau_si=360000; 
odeparams.tar_hepasi=0.6;%IFG weak r20
odeparams.tau_hepasi=360000;
odeparams.Gs=100;%IFG weak r20
...
%% plot data
DATA=readtable('IFG_weak_r20.xlsx');
fs=12;
fn='arial';
...
text(3.8,210,'2hPG', 'fontsize',fs2,'fontname',fn);
...
text(6,40,'T2D','fontsize',fs10,'fontname',fn);
